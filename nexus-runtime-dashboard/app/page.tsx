...
export default function Page() {
  ...
  useEffect(() => { if (locked && streamRef.current) streamRef.current.scrollTop = streamRef.current.scrollHeight }, [state.events, locked])
