"""Move file operation for the Nexus File System Plugin.
...
def move(data: dict) -> dict:
    ...
    if not isinstance(data, dict):
        return build_response("ERROR", "MOVE requires a dictionary payload.")
    ...
    # Move
    success, error_msg = safe_move(source_path, dest_path)
    if not success:
